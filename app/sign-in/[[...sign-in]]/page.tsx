  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50">
      <div className="w-full max-w-md px-4 text-center">
        ...
        <h1 className="font-heading text-2xl font-extrabold text-gray-900">Welcome back</h1>
        <p className="mt-2 text-sm text-gray-500">Authentication is being configured</p>
        <div className="mt-6 p-6 bg-indigo-50 rounded-xl border border-indigo-200">
          ...
          <p className="text-xs text-gray-500 mt-2">The sign-in page will be available once <code className="bg-indigo-100 px-1 rounded font-mono">NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY</code> and <code className="bg-indigo-100 px-1 rounded font-mono">CLERK_SECRET_KEY</code> are set.</p>
        </div>
